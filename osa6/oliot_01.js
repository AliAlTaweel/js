...
/*
Luo olio `opiskelija` ominaisuuksilla: `nimi` arvolla "Emilia" ja `tiedot` oliona, jossa ominaisuudet `ikä` 
asetettuna 22 ja `kurssi` asetettuna "JavaScript".
...
function tervehdi() {
  let henkilö = {
    kirjaa: "Hei, nimeni on Aleksi",
  };
}
tervehdi().henkilö.kirjaa;
