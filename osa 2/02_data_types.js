...
- Luo muuttuja nimeltään hobbies ja anna sille taulukko, joka sisältää muutamia merkkijonoarvoja 
- (esim. harrastukset).
...
let name = "Ali";
let isStudent = true;
let hoobies = ["salibandi", "ylkäballo"];
let info = {schoolname: "B.C" , grade: 15}

console.log("hoppies are",hoobies)
console.log("info grade is",info.grade)
console.log(typeof hoobies)
console.log(isStudent,info, hoobies)

// to change integer to char
let vastaus = 42;
